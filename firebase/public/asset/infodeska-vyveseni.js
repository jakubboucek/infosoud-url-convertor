import {convertVyveseniPath} from './infodeska-converter.js';
...
try {
    ...
    const newUrl = new URL(convertVyveseniPath(params), infodeskaOrigin);

    console.log('Převedená adresa vyvěšení:', newUrl.toString());

    const a = document.createElement('a');
    a.href = newUrl.toString();
    a.textContent = 'Nalezen nový odkaz na vyvěšený dokument. Klikněte zde pro přesměrování.';
    ...
    console.error('Chyba při převodu URL vyvěšení:', e);
